...
### Installing Sparkly
Next you need to install Sparkly. You can find instructions for installing Sparkly and its prerequisites (Python, Java, JCC, PyLucene, Joblib, mmh3, Numba, Numpy, Numpydoc, Pandas, Psutil, Pyarrow, Pyspark, Scipy, and Tqdm) here: [link goes here]()
